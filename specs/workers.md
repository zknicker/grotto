...
Workers are Haus's view of autonomous background agent work.

## Product Expectations

- A worker is an inspectable unit of background work.
- Workers should feel like first-class Haus objects rather than leaked runtime task records.
...
- A worker is distinct from a planning task. Those should remain separate Haus primitives even if
