...
ALTER TABLE "chats" ADD COLUMN "color" text;--> statement-breakpoint
ALTER TABLE "chats" ADD COLUMN "icon" text;--> statement-breakpoint
ALTER TABLE "chats" ADD CONSTRAINT "chats_shape" CHECK ((
                ...
                or (
                    ...
                    and "chats"."color" is null
                    and "chats"."icon" is null
