...
import type { HostedAgentExecutionJournal } from '@tavern/api';
...
export function HostedTurnDetailsDrawer({
    access,
    agentAvatarUrl,
    agentId,
    agentName,
    ...
    return (
        <TurnDetailsDrawer
            ...
            open={open}
        >
            <HostedTurnActivitySummary agentId={agentId} runId={runId} serverId={serverId} />
...
function HostedTurnActivitySummary({
    agentId,
    runId,
    serverId,
}: {
...
function JournalContents({ journal }: { journal: HostedAgentExecutionJournal }) {
    return (
