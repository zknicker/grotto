import type { HostedAgentSkillFile, HostedAgentSkillFileRequest } from '@tavern/api';
...
export async function updateHostedAgentSkillFile(
    db: GrottoDatabase,
    connections: ComputerConnections,
    member: GrottoUser | null,
    input: {
...
export async function deleteHostedAgentSkillFile(
    db: GrottoDatabase,
    connections: ComputerConnections,
    member: GrottoUser | null,
    input: {
