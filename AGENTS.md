...
- `DESIGN.md` and `apps/website/src/styles/default-theme.css` are generated by the
  [saved Grotto design system](https://heroui.pro/ds/9e70cb0a-050a-4aca-8cc4-4d38eafb56ad)
  in HeroUI Pro. Do not hand-edit either file. Change the design system, then replace both exports
  together. Product CSS may own layout or behavior that HeroUI cannot express, but it must not
