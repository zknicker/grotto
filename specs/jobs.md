...
Jobs are Haus's internal scheduled and on-demand background work.

## Product Expectations

- Jobs are Haus-owned operational primitives.
- A job should make it easy to understand what Haus is doing in the background and whether it is
  healthy.
...
- Jobs cover Haus's own background work such as sync, ingest, refresh, and reconciliation tasks.
