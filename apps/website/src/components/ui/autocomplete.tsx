...
export function AutocompleteItem({
    ...
    return (
        <AutocompletePrimitive.Item
            className={cn(
                'flex min-h-8 cursor-default select-none items-center rounded-sm px-2 py-1 text-base outline-none data-disabled:pointer-events-none data-highlighted:bg-legacy-accent data-highlighted:text-legacy-accent-foreground data-disabled:opacity-64 sm:min-h-7 sm:text-sm',
                className
            )}
