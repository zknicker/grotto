...
if (process.platform !== 'darwin') {
    console.error('Haus desktop release install is only supported on macOS.');
    process.exit(1);
}
...
const destinationAppPath = '/Applications/Haus.app';
...
console.log(`Installed Haus.app to ${destinationAppPath}`);
