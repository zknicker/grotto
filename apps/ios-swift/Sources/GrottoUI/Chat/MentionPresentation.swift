...
public enum RichReferenceMark: Hashable, Sendable {
    ...
    case brandGlyph(GrottoIconName, ReferenceBrandInk)
...
public enum RichMessageSegment: Hashable, Sendable {
    ...
    /// A Markdown link this client does not chip — a `grotto://` resource, a
...
public struct RichReferencePresentation: Hashable, Sendable {
    ...
    /// other kind names a Grotto record, and the phone has no route to one yet.
