...
struct ReferenceLabelShapingTests {
    ...
    @Test func readsAPullRequestNumberOutOfEveryGitHubShapedURL() {
        #expect(RichReferenceWireForm
            .pullRequestNumber(in: "https://github.com/grotto/grotto/pull/56") == 56)
        #expect(RichReferenceWireForm
            .pullRequestNumber(in: "https://api.github.com/repos/grotto/grotto/pulls/56") == 56)
        #expect(RichReferenceWireForm
            .pullRequestNumber(in: "https://github.com/grotto/grotto/pull/56/files") == 56)
        #expect(RichReferenceWireForm
            .pullRequestNumber(in: "https://github.com/grotto/grotto/pull/0") == nil)
        #expect(RichReferenceWireForm
            .pullRequestNumber(in: "https://github.com/grotto/grotto/tree/main") == nil)
    }

    @Test func labelsAWebsiteByItsWordsAndAWordlessOneByItsHost() {
        #expect(websiteLabel(text: "the notes", target: "https://grotto.dev/x") == "the notes")
        #expect(websiteLabel(text: "https://grotto.dev/x", target: "https://grotto.dev/x") == "grotto.dev")
        #expect(websiteLabel(text: "https://www.grotto.dev", target: "https://www.grotto.dev") == "grotto.dev")
    }
