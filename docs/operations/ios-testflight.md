...
Automatic signing uses Apple Development for the archive, then Apple Distribution for the App Store
export. The job does not invite testers or submit the app for public App Review.
