...
summary: Decision to store Haus Widgets as first-class widget response activity.
read_when:
...
Haus stores agent-rendered Widgets as `widget` response activity instead of hiding them inside
