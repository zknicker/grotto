...
-- summary derivation the read path used before this, which is why the four
-- snapshot columns are added nullable and only then made NOT NULL.
...
ALTER TABLE "message_causes" ALTER COLUMN "title" SET NOT NULL;--> statement-breakpoint
