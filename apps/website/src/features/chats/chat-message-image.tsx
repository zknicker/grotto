    ...
    return (
        <>
            <button
                ...
                className="size-16 cursor-zoom-in overflow-hidden rounded-xl border border-separator bg-surface-secondary p-0 text-left outline-none transition-colors hover:bg-surface-hover focus-visible:ring-2 focus-visible:ring-focus"
