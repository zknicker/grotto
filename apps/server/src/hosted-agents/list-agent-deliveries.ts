import type { HostedAgentDeliveriesInput, HostedAgentDeliveryRecord } from '@tavern/api';
 ...
 */
export async function listHostedAgentDeliveries(
    db: GrottoDatabase,
    member: GrottoUser | null,
    input: HostedAgentDeliveriesInput
): Promise<HostedAgentDeliveryRecord[]> {
