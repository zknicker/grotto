...
function computerFact(step: ComputerUpdateStep): HausComponentFact {
    return {
...
function statusForStep(step: ComputerUpdateStep | DesktopUpdateStep): HausComponentFact['status'] {
