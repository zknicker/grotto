/**
 * Tavern-composed agent system prompt body — the Raft-template rewrite
 * (specs/raft-alignment/ws2-prompt-draft.md). The text below is TRANSCRIPTION
 * of that operator-approved draft; do not editorialize here.
 *
