    ...
    var body: some View {
        Form {
            ...
            Section {
                ...
                Text("Connect opens Cursor sign-in on the selected Computer. Finish signing in there; credentials stay on that Computer. Its agents can then use Cursor from any Grotto device.")
            }
        }
