...
Grotto 2.0 requires Computer protocol 17 for Agent configuration briefs and the current Browser
...
actions; the hosted App and iPhone 2.0 send that version. Older iPhone builds require an update,
