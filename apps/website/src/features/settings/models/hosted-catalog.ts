...
export interface HostedModelsComputer extends ComputerPresentation {
...
export function buildHostedModelCatalog(computers: HostedModelsComputer[]) {
...
export function buildRuntimeAccess(computers: HostedModelsComputer[]) {
