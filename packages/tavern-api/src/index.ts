...
export type TavernAgentManualSearchResponse = TavernApiSchema<'AgentManualSearchResponse'>;
export type TavernAgentManualTopic = TavernApiSchema<'AgentManualTopic'>;
