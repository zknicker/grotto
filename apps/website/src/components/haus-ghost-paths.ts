...
export const VIEWBOX_WIDTH = 192;
export const VIEWBOX_HEIGHT = 204;
...
/**
 * Both eyes are exact stadiums — two straight flanks closed by semicircular
 * caps — so the ends stay round at any size. The auto-trace that produced the
 * body left knots across the caps, and those knots read as flat corners once
 * the mark was drawn large. Centers, tilt, width, and length come from the
 * app-icon eye layer; the caps are quarter-circle cubics at the 0.5523 kappa.
 */
export const EYES_PATH =
    'M116.412 64.907L115.117 88.892C114.702 96.582 108.131 102.479 100.442 102.064C92.752 101.649 86.854 95.078 87.27 87.389L88.565 63.404C88.98 55.714 95.551 49.817 103.24 50.232C110.93 50.647 116.828 57.218 116.412 64.907z' +
    'M155.559 64.083L156.29 86.815C156.523 94.063 150.836 100.126 143.589 100.359C136.342 100.592 130.278 94.906 130.045 87.659L129.314 64.927C129.081 57.679 134.768 51.616 142.015 51.383C149.262 51.15 155.326 56.836 155.559 64.083z';
