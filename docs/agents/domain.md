---
summary: Domain-document layout for engineering skills in Haus.
read_when:
  - using architecture, diagnosis, domain-modeling, or TDD skills in this repo
  - changing where Haus domain context or ADRs live
---

# Domain docs

Haus uses a single-context domain-doc layout.
